...
<head>
    ...
    <script type="text/javascript" src="/cvContactUs/js/chatError.js"></script>
...
<base href='{field{*fldinst{HYPERLINK "view-source:https://optimum.custhelp.com/euf/rightnow/optimized/1391696935/themes/standard/"}}{fldrslt cf2 ul ulc2 https://optimum.custhelp.com/euf/rightnow/optimized/1391696935/themes/standard/}}'></base>
<link href='https://optimum.custhelp.com/euf/rightnow/optimized/1391696935/pages/chat/chat_landing.themes.standard.SITE.css' rel='stylesheet' type='text/css' media='all' />
...
.rn_ChatServerConnect{background:#EFEFF4 url(https://optimum.custhelp.com/euf/rightnow/optimized/1391696935/themes/standard/images/layout/whitePixel.png) repeat-x scroll 0 0;border:solid #BBBBBB;border-width:1px 0;line-height:1.25em;margin:0 0 1em;padding:5px;}
...
.rn_ChatEngagementStatus{background:#EFEFF4 url(https://optimum.custhelp.com/euf/rightnow/optimized/1391696935/themes/standard/images/layout/whitePixel.png) repeat-x scroll 0 0;border:solid #BBBBBB;border-width:1px 0;padding:5px;line-height:1.25em;margin:0 0 1em;}
...
.rn_ChatQueueWaitTimeContainer{background:#EFEFF4 url(https://optimum.custhelp.com/euf/rightnow/optimized/1391696935/themes/standard/images/layout/whitePixel.png) repeat-x scroll 0 0;border:1px solid #BBBBBB;border-width:1px;padding:5px;margin:0em 1em 1em 1em;line-height:1.25em;text-align:left;}
...
.rn_ChatAgentStatus{background:#EFEFF4 url(https://optimum.custhelp.com/euf/rightnow/optimized/1391696935/themes/standard/images/layout/whitePixel.png) repeat-x scroll 0 0;border:solid #BBBBBB;border-width: 1px 1px 0;padding:5px;line-height:1.25em;margin: 0 1em 0;}
...
.rn_ChatQueueSearch{background:#EFEFF4 url(https://optimum.custhelp.com/euf/rightnow/optimized/1391696935/themes/standard/images/layout/whitePixel.png) repeat-x scroll 0 0;border:1px solid #BBBBBB;line-height:1.25em;margin:1em 1em 1em 1em;padding:5px;text-align:center;}
...
.rn_RightNowLogo a{background:url(https://optimum.custhelp.com/euf/rightnow/images/RightNowLogo.png) no-repeat scroll 0 0 !important;display:block !important;height:22px !important;width:134px !important;}
...
<form class='rn_Hidden'><input id='rn_History_Field' type='hidden'/></form>
    ...
    <button id="rn_ChatDisconnectButton_0_Button" title="Terminate the Chat"><img src="https://optimum.custhelp.com/euf/rightnow/optimized/1391696935/themes/standard/images/chat_disconnect.png" alt="Terminate the Chat" /> Disconnect</button>
	<button id="rn_ChatDisconnectButton_0_ButtonClose" title="Close the window" style="display: none;"><img src="https://optimum.custhelp.com/euf/rightnow/optimized/1391696935/themes/standard/images/chat_close.png"> Close</button>
</span>

                            <!--rn:widget path="chat/ChatOffTheRecordButton"/-->
                            <span id="rn_ChatPrintButton_1" class="rn_ChatPrintButton rn_Hidden">
    <button id="rn_ChatPrintButton_1_Button" title="Print the Transcript" onClick="window.print()"><img src="https://optimum.custhelp.com/euf/rightnow/optimized/1391696935/themes/standard/images/chat_print.png" alt="Print the Transcript" /> </button>
</span>
                        </div>
                    </div>
    ...
    <div id="rn_ChatEngagementStatus_3_Searching" class="rn_SearchingDetailMessage rn_Hidden">
        <img alt="" src="{field{*fldinst{HYPERLINK "view-source:https://optimum.custhelp.com/app/chat/chat_landing/first_name/weugfhuwho/last_name/owehfoihwo/email/fihoweih%40ehoehoi.com/subject/images/indicator.gif"}}{fldrslt cf2 ul ulc2 images/indicator.gif}}"/>&nbsp;<span>Searching for an available agent</span>
    </div>
...
<div id="rn_ChatQueueWaitTime_4" class="rn_ChatQueueWaitTimeContainer rn_Hidden">
    ...
    <span id="rn_ChatQueueWaitTime_4_AverageWaitTime" class="rn_ChatAverageWaitTime rn_Hidden" title="Average time before an agent becomes available."></span>
                    ...
                    <div id="rn_ChatAgentStatus_5_Agent_19">
                    	<img src="https://optimum.custhelp.com/euf/rightnow/optimized/1391696935/themes/standard/images/chat_agent.png"> </div>
				</div>
    ...
    <div id="rn_ChatAttachFileButton_11_FileAttachContent" class="rn_ChatFileAttachContent rn_Hidden">
            ...
            <img src='{field{*fldinst{HYPERLINK "view-source:https://optimum.custhelp.com/app/chat/chat_landing/first_name/weugfhuwho/last_name/owehfoihwo/email/fihoweih%40ehoehoi.com/subject/images/indicator.gif"}}{fldrslt cf2 ul ulc2 images/indicator.gif}}' alt="" id="rn_ChatAttachFileButton_11_Indicator" class="rn_Hidden"/>       
