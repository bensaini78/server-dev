...
<!-- mp_trans_disable_start -->	
	<section class="live">
		...
		<form:form modelAttribute="uploadForm" id='emailForm' name="emailForm" action="#" enctype="multipart/form-data" method="post" >
	   ...
	   <div class="row"> 
	    <div class="span8">
	 	<div id="rn_PageTitle" class="span12 rn_AskQuestion padding-0">
				...
				<div id="left"><h4></h4><p>Email support is available 24 hours a day, seven days a week.</p></h4></div>
			...
			<div id="product" class="element-input span6" >
				...
				<div class="medium"><span>
						...
						<div class="custom-select">
							<div id="CustProdEmailD" class="styledSelect" tabindex="1">Make a selection</div>
		...
		<div class="span4">
			<span class="ask_label" id="indicates_required"><font color="red">*</font> Indicates required fields</span>
		...
		<div class="span4">
			...
			<div class="messagebox">
				...
				<p>You can also visit our <a href="${ctx['resi_net.answer.center']}" class="blue">Answer Center</a> for information online regarding frequently asked questions or click <a href="${ctx['resi_net.faq.list']}" class="blue">here</a> for e-mail support.</p>
	...
	<script>
		var hostUrl = '/cvContactUs';
			...
			$.getScript(hostUrl+"/js/jquery.min.js", function(script, textStatus){
				...
				$.getScript(hostUrl+"/js/email.js").done(function(script, textStatus){
					...
					$.getScript(hostUrl+"/js/jquery.validate.min.js").done(function(script, textStatus){
							...
							$.getScript(hostUrl+"/js/commonCV_Forms.js").done(function(script, textStatus){
								...
								$.getScript(hostUrl+"/js/formoid-default-skyblue.js").done(function(script, textStatus){
									...
									setTimeout(function(){validateForms();
									 },2500);
									onLoadCall();
								});
