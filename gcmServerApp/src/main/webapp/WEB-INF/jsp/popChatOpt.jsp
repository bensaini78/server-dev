...
<!--base href='http://optimum.custhelp.com/euf/rightnow/optimized/1391696935/themes/standard/'></base-->
<link href='/cvContactUs/css/chat_landing.themes.standard.SITE.css' rel='stylesheet' type='text/css' media='all' />
<link type="text/css" rel="stylesheet" href="/cvContactUs/css/style.css" />
...
.rn_ChatServerConnect{background:#EFEFF4 url(/euf/rightnow/optimized/1391696935/themes/standard/images/layout/whitePixel.png) repeat-x scroll 0 0;border:solid #BBBBBB;border-width:1px 0;line-height:1.25em;margin:0 0 1em;padding:5px;}
...
.rn_ChatEngagementStatus{background:#EFEFF4 url(/euf/rightnow/optimized/1391696935/themes/standard/images/layout/whitePixel.png) repeat-x scroll 0 0;border:solid #BBBBBB;border-width:1px 0;padding:5px;line-height:1.25em;margin:0 0 1em;}
...
.rn_ChatQueueWaitTimeContainer{background:#EFEFF4 url(/euf/rightnow/optimized/1391696935/themes/standard/images/layout/whitePixel.png) repeat-x scroll 0 0;border:1px solid #BBBBBB;border-width:1px;padding:5px;margin:0em 1em 1em 1em;line-height:1.25em;text-align:left;}
...
.rn_ChatAgentStatus{background:#EFEFF4 url(/euf/rightnow/optimized/1391696935/themes/standard/images/layout/whitePixel.png) repeat-x scroll 0 0;border:solid #BBBBBB;border-width: 1px 1px 0;padding:5px;line-height:1.25em;margin: 0 1em 0;}
...
.rn_ChatQueueSearch{background:#EFEFF4 url(/euf/rightnow/optimized/1391696935/themes/standard/images/layout/whitePixel.png) repeat-x scroll 0 0;border:1px solid #BBBBBB;line-height:1.25em;margin:1em 1em 1em 1em;padding:5px;text-align:center;}
...
.rn_RightNowLogo a{background:url(/euf/rightnow/images/RightNowLogo.png) no-repeat scroll 0 0 !important;display:block !important;height:22px !important;width:134px !important;}
...
<form class='rn_Hidden'><input id='rn_History_Field' type='hidden'/></form>
                ...
                <div id="rn_ChatDialogContainer">
                    ...
                    <div id="rn_ChatDialogHeaderContainer">
                        ...
                        <div id="rn_ChatDialogHeaderButtonContainer">
                            <span id="rn_ChatDisconnectButton_0" class="rn_ChatDisconnectButton">
    <button id="rn_ChatDisconnectButton_0_Button" title="Terminate the Chat"><img src="http://optimum.custhelp.com/euf/rightnow/optimized/1391696935/themes/standard/images/chat_disconnect.png" alt="Terminate the Chat" /> Disconnect</button>
</span>
                            <!--rn:widget path="chat/ChatOffTheRecordButton"/-->
                            <span id="rn_ChatPrintButton_1" class="rn_ChatPrintButton rn_Hidden">
    <button id="rn_ChatPrintButton_1_Button" title="Print the Transcript"><img src="images/chat_print.png" alt="Print the Transcript" /> </button>
</span>
                        </div>
                    </div>
                    <!--div id="rn_ChatServerConnect_2" class="rn_ChatServerConnect">
            <div id="rn_ChatServerConnect_2_Connector">
                            <img alt="" id="rn_ChatServerConnect_2_ConnectingIcon" src="images/indicator.gif"/>&nbsp;<span id="rn_ChatServerConnect_2_Message">Please wait while we establish a connection to the Chat Server.</span>
                    </div>
    </div-->
                    <div id="rn_ChatEngagementStatus_3" class="rn_ChatEngagementStatus rn_Hidden">
    ...
    <div id="rn_ChatEngagementStatus_3_Searching" class="rn_SearchingDetailMessage rn_Hidden">
        <img alt="" src="images/indicator.gif"/>&nbsp;<span>Searching for an available agent</span>
    </div>
    ...
    <span id="rn_ChatQueueWaitTime_4_QueuePosition" class="rn_ChatQueuePosition rn_Hidden" title="Your current position in the queue.">Please wait while your queue position is calculated...</span>
    ...
    <span id="rn_ChatQueueWaitTime_4_AverageWaitTime" class="rn_ChatAverageWaitTime rn_Hidden" title="Average time before an agent becomes available."></span>
                    ...
                    <div id="chatbox" class="rn_ChatTranscript">
</div>
                    <div id="rn_PreChatButtonContainer">
                        <div id="rn_ChatCancelButton_7" class="rn_ChatCancelButton rn_Hidden">
    ...
    <button id="rn_ChatRequestEmailResponseButton_8_Button" title="Open a new browser window and navigate to the Ask a Question page">Request Email Response</button>
                    ...
                    <div id="rn_ChatPostMessage_9" class="rn_ChatPostMessage">
    <div>Type your message here, then click Send or press &lt;Enter&gt;</div>
    <fieldset>         <legend></legend>
        <span>
            <textarea id="usermsg" rows="3" cols="50"></textarea>
        </span>
    </fieldset>
</div>
                    <div id="rn_InChatButtonContainer">
					</br>
                        <span id="rn_ChatSendButton_10" class="rn_ChatSendButton" title="Send the message to the agent">
    ...
    <div id="rn_ChatAttachFileButton_11_FileAttachContent" class="rn_ChatFileAttachContent rn_Hidden">
        <form method="post" id="rn_ChatAttachFileButton_11_Form" action="">
            <input name="file" id="rn_ChatAttachFileButton_11_Browse" type="file" size="35"/>
            <img src='images/indicator.gif' alt="" id="rn_ChatAttachFileButton_11_Indicator" class="rn_Hidden"/>        </form>
    ...
    <iframe id="rn_ChatCoBrowseButton_12_IFrame"></iframe>
                    ...
                    <div id="rn_ChatQueueSearchContainer">
                        <div id="rn_ChatQueueSearch_13" class="rn_ChatQueueSearch rn_ScreenReaderOnly">
    ...
    <input id="rn_KeywordText2_14_Text" name="rn_KeywordText2_14_Text" type="text" maxlength="255" value=""  />
        ...
        <div id="rn_Footer rn_Hidden">
            <div id="rn_RightNowCredit">
                <div class="rn_FloatRight">
                    <span id="rn_RightNowLogo_16" class="rn_RightNowLogo rn_Hidden">
<a href="" target="_blank"  title="Powered By RightNow Technologies"><span class="rn_ScreenReaderOnly">Powered By RightNow Technologies</span></a>
</span>
                </div>
            </div>
        </div>
