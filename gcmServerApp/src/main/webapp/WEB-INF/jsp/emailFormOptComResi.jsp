	...
	<section class="live">
		...
		<form:form modelAttribute="uploadForm" id='chatForm' name="chatForm" action="#" enctype="multipart/form-data" method="post">
			<div id="topBar" class="headerPart">
					<img alt="Optimum" src="/cvContactUs/images/optimum_blue.png">
			</div>
			<div class="row">
			<div class="span8">
		...
		<input type="hidden" name="CustProd" id="CustProd" value="Sales"></input>
		<input type="hidden" name="ServiceSubType" id="ServiceSubType" value="Sales"></input>
		<br style="clear:both;">
